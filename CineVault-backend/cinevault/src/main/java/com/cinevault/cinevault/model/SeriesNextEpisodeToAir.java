...
@Entity
@Table(name = "series_next_episode_to_air")
public class SeriesNextEpisodeToAir {
    @Id
    ...
    public SeriesNextEpisodeToAir() {}

    public SeriesNextEpisodeToAir(Long episodeId, String name, String overview, LocalDate airDate, Integer episodeNumber, Integer seasonNumber, String stillPath, Double voteAverage, Integer voteCount) {
